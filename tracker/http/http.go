...
import (
	...
	"github.com/timechainlabs/torrent/tracker/shared"
	"github.com/timechainlabs/torrent/tracker/udp"
	"github.com/timechainlabs/torrent/version"
)
...
func setAnnounceParams(_url *url.URL, ar *AnnounceRequest, opts AnnounceOpt) {
	...
	// %2B, and + has no other special meaning. See https://github.com/timechainlabs/torrent/issues/534.
